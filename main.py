...
if __name__ == '__main__':
    ...
    # clf = LogisticRegression(C=0.001, max_iter=100000).fit(X_train, y_train)
    clf = LogisticRegression(C=0.1, penalty='l1', max_iter=100000, solver='liblinear').fit(X_train, y_train)
